...
export const BOX_CATEGORIES: readonly BoxCategoryDef[] = [
  ...
  { id: 'rent', label: 'Rent', short: 'Housing first', tab: 'essentials', lockedUntilDebtFree: false },
  { id: 'food', label: 'Food', short: 'Groceries and meals', tab: 'essentials', lockedUntilDebtFree: false },
  {
    id: 'transportation',
    label: 'Transportation',
    short: 'Transit, fuel, upkeep',
    tab: 'essentials',
    lockedUntilDebtFree: false,
  },
  { id: 'medical', label: 'Medical', short: 'Health and care costs', tab: 'essentials', lockedUntilDebtFree: false },
  {
    id: 'personal',
    label: 'Personal',
    short: 'Daily essentials',
    tab: 'essentials',
    lockedUntilDebtFree: false,
  },
  {
  ...
  },
  {
    ...
    short: 'Your contribution; match lands later',
    tab: 'essentials',
    lockedUntilDebtFree: false,
  },
  ...
  },
  {
    id: 'crypto',
    label: 'Crypto',
    short: 'High-risk, high-volatility',
    tab: 'investments',
    lockedUntilDebtFree: true,
  },
] as const;
