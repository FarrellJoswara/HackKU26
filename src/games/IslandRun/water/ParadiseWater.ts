...
export interface ParadiseWaterParameters {
  textureWidth?: number;
  ...
  side?: Side;
  fog?: boolean;
  /** Multiplies Fresnel reflectance before mixing (lower = more waterColor). Default 0.72 */
  reflectanceScale?: number;
  /** Weight of reflection sample (stock ~0.9). Default 0.52 */
  reflectionSampleWeight?: number;
  /** Boosts subsurface scatter tint. Default 1.32 */
  scatterBoost?: number;
}

export class ParadiseWater extends Mesh {
  readonly isWater = true;

  declare material: ShaderMaterial;

  constructor(geometry: BufferGeometry, options: ParadiseWaterParameters = {}) {
    super(geometry);
    ...
    const reflectanceScale = options.reflectanceScale !== undefined ? options.reflectanceScale : 0.72;
    const reflectionSampleWeight =
      options.reflectionSampleWeight !== undefined ? options.reflectionSampleWeight : 0.52;
    const scatterBoost = options.scatterBoost !== undefined ? options.scatterBoost : 1.32;
    ...
    const mirrorShader = {
      ...
      uniforms: UniformsUtils.merge([
        ...
        UniformsLib['lights'],
        {
          ...
          uReflectanceScale: { value: reflectanceScale },
          uReflectionWeight: { value: reflectionSampleWeight },
    ...
    this.onBeforeRender = function (
      ...
      mirrorCamera.far = (camera as PerspectiveCamera).far;
