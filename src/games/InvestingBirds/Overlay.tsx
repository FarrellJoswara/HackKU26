...
export function Overlay(props: OverlayProps) {
  ...
  // Tower category label — projected from world coords.
  ...
  return (
    ...
    >
      {/* Tower category label — projected via world-to-screen */}
      {currentLevel && towerLabelScreen ? (
        ...
        >
          <div
            className="rounded-full px-3 py-1 text-sm font-bold tracking-wide text-white shadow-lg"
